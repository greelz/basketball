...
export default function BigButton({ url, content, variant }: Props) {
    ...
    if (!variant) { barColor = "bggraygrad w-full h-full p-4 rounded-md cursor-pointer border border-gray-800 flex align-center justify-center items-center text-md" }
