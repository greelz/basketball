...
export default function UploadExport() {
    ...
    return (
        <div className="bg-transparent border-white border p-4 rounded-md  w-full">
            ...
            <button
                ...
                className="mt-4 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md bgorangegrad"
            >
                Upload
            </button>
        </div>
