                ...
                <div className="py-2">
                    {options.map((option, idx) => (
                        <button
                            ...
                            className=" text-left px-4 py-2 text-sm text-white bg-gray-800 hover:bg-gray-700 transition-all duration-200 ease-in-out  w-full h-full p-4 rounded-md cursor-pointer border border-black flex align-left justify-center items-center text-md"
                        >
                            {option.ddlabel}
                        </button>
                    ))}
